...
- **Responsividade obrigatória até 480px (o professor vai testar no F12, simulando iPhone XR — 414px de largura real, até 480px no máximo):** revisar a media query existente (`@media (max-width: 600px)`) e testar especificamente nessa largura — não só "por cima", testar de verdade abrindo as Ferramentas de Desenvolvedor, ativando o modo de dispositivo móvel, selecionando iPhone XR (ou uma largura customizada de 414px/480px), e navegando pelas 3 páginas conferindo que nada quebra, sobrepõe ou corta conteúdo. Prestar atenção especial nos elementos adicionados mais recentemente (faixa de Concessionárias, `.pagina-wrapper` com borda lateral, campo de busca do footer), que ainda não foram testados nessa largura.
